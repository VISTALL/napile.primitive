...
public class CHashIntObjectMap<V> extends AbstractIntObjectMap<V> implements CIntObjectMap<V>, Serializable
{
	...
	transient Set<IntObjectMap.Entry<V>> entrySet;
	...
	{
		for(IntObjectMap.Entry<? extends V> e : m.entrySet())
		{
	 ...
	 */
	final class WriteThroughEntry extends AbstractIntObjectMap.SimpleEntry<V>
	{
	...
	final class EntrySet extends AbstractSet<IntObjectMap.Entry<V>>
	{
