...
import io.github.joealisson.primitive.lists.impl.CArrayIntList;
...
public class CArrayIntSet extends AbstractIntSet implements java.io.Serializable
{
	 ...
	 *
	 * @param items array containing elements to be added to this set
	 * @return true if this set changed as a result of the call
	 * @throws NullPointerException if the specified array is null
	 * @see #add(int)
	 */
	public boolean addAll(int[] items) {
		return  al.addAllAbsent(items) > 0;
	}
