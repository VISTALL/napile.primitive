 ...
 * @version %I%, %G%
 * @see LongCollection
 * @see io.github.joealisson.primitive.lists.LongList
 * @see SortedIntSet
 * @see io.github.joealisson.primitive.sets.impl.HashLongSet
 * @see io.github.joealisson.primitive.sets.abstracts.AbstractLongSet
 * @since 1.0.0
 */
