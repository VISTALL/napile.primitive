...
import io.github.joealisson.primitive.function.IntObjConsumer;
...
public interface IntMap<V> {
     ...
     * @since 9
     */
    static <V> IntMap<V> of(int k1, V v1, int k2, V v2) {
     ...
     * @since 9
     */
    static <V> IntMap<V> of(int k1, V v1, int k2, V v2, int k3, V v3, int k4, V v4) {
     ...
     * @since 9
     */
    static <V> IntMap<V> of(int k1, V v1, int k2, V v2, int k3, V v3, int k4, V v4, int k5, V v5) {
     ...
     */
    static <V> IntMap<V> of(int k1, V v1, int k2, V v2, int k3, V v3, int k4, V v4, int k5, V v5,
                               int k6, V v6, int k7, V v7, int k8, V v8) {
        return new ImmutableCollections.MapN<>(k1, v1, k2, v2, k3, v3, k4, v4, k5, v5,
                k6, v6, k7, v7, k8, v8);
    }
     ...
     */
    static <V> IntMap<V> of(int k1, V v1, int k2, V v2, int k3, V v3, int k4, V v4, int k5, V v5,
                               int k6, V v6, int k7, V v7, int k8, V v8, int k9, V v9) {
        return new ImmutableCollections.MapN<>(k1, v1, k2, v2, k3, v3, k4, v4, k5, v5,
     ...
     */
    static <V> IntMap<V> of(int k1, V v1, int k2, V v2, int k3, V v3, int k4, V v4, int k5, V v5,
                               int k6, V v6, int k7, V v7, int k8, V v8, int k9, V v9, int k10, V v10) {
        return new ImmutableCollections.MapN<>(k1, v1, k2, v2, k3, v3, k4, v4, k5, v5,
    ...
    static <V> IntMap<V> ofEntries(Entry<? extends V>... entries) {
    ...
    static <V> IntMap<V> copyOf(IntMap<? extends V> map) {
        if (map instanceof ImmutableCollections.AbstractImmutableMap) {
            return (IntMap<V>)map;
        } else {
            return (IntMap<V>) IntMap.ofEntries(map.entrySet().toArray(new Entry[0]));
        }
    }
}
